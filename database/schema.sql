...
CREATE TABLE venta (
    ...
    id_cliente INT,
    CONSTRAINT fk_venta_cliente FOREIGN KEY (id_cliente) REFERENCES cliente(id_cliente) ON DELETE
    SET NULL
);
...
CREATE TABLE producto (
    ...
    id_proveedor INT,
    esta_activo BOOLEAN DEFAULT TRUE,
    CONSTRAINT fk_producto_proveedor FOREIGN KEY (id_proveedor) REFERENCES proveedor(id_proveedor) ON DELETE
    SET NULL
);
-- Tabla subtipo ropa
CREATE TABLE ropa (
    ...
    CONSTRAINT fk_ropa_producto FOREIGN KEY (id_producto) REFERENCES producto(id_producto) ON DELETE CASCADE
);
...
CREATE TABLE calzado (
    ...
    CONSTRAINT fk_calzado_producto FOREIGN KEY (id_producto) REFERENCES producto(id_producto) ON DELETE CASCADE
);
...
CREATE TABLE accesorios (
    ...
    CONSTRAINT fk_accesorios_producto FOREIGN KEY (id_producto) REFERENCES producto(id_producto) ON DELETE CASCADE
);
